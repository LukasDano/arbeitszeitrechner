$(document).ready(function () {
    ...
    const timeValues = {
        ...
        get workedDaysForWeek() {
            return getWorkedDaysForWeek(this.weekWorkTime);
        },
        get weekOverTime() {
            return calculateWeekOverTime(this.floatThisWeek, this.workedDaysForWeek, this.weekWorkTime);
        }
    };
    ...
    function setWeekOverTime() {
        const weekOverTimeAusgabe = formatWeekOverTime(timeValues.weekOverTime);
